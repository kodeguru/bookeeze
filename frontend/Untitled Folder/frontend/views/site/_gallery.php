<?php $mainAsset = Yii::$app->request->baseUrl.'/frontend/assets/'; ?>
<!-- gallery -->
<section class="page-gallery page-gallery__home">
    ...
    <div class="clearfix"></div>
     <ul id="isotopeContainer" class="gallery items-row cols-3  hover_true grid">
        <li class="gallery-item mix mix_all gallery-grid gallerylatest firstItem" data-date="20141111192044" data-name="Suspendisse venenatis" data-popularity="220" style="display: inline-block;  opacity: 1;">
            <header><h2>Top hotels around</h2></header>
                ...
                <div class="mask_wrap">
                  <div class="mask_cont">
                      ...
                      <div class="item_header">
                        <h3 class="item_title">                     
                          <a href="<?= $mainAsset ?>/images/109-gallery-9"> 
                            <span class="item_title_part0">Suspendisse</span> 
                            <span class="item_title_part1">venenatis</span> 
                          </a>
                        </h3>           
                      </div>
                    ...
                    <!-- info BOTTOM -->      
                    <div class="item_more">
                      <a href="<?= $mainAsset ?>/images/gallery/gallery-img9.jpg" class="galleryZoom">
    ...
    <div class="mask_wrap">
      <div class="mask_cont">
          ...
          <div class="item_header">
              <h3 class="item_title">                     
                <a href="<?= $mainAsset ?>/images/111-gallery-8"> 
                  <span class="item_title_part0">Ut</span> 
                  <span class="item_title_part1">mauris</span> 
                  <span class="item_title_part2">arcu</span> 
                </a>
              </h3>           
          </div>
          <!-- info BOTTOM -->       
