...
<?php     
              ...
              //absoluteHomeUrl
                        ...
                        if (Yii::$app->user->isGuest) {
                            ...
                            $items[] = ['label' => $username, 'url' => ['#'], 'options'=>['class'=>' small-btns dropdown'],'linkOptions'=>['class'=>'dropdown-toggle','data-toggle'=>'dropdown'],'linkTemplate' => '<a href="{url}"><<img alt="Avatar" src="assets/img/avatar2.jpg"/><span>{label}</span><b class="fa fa-user"></b></a>',
                                'items' => [
...
// echo Nav::widget([
//         'options' => ['class' => 'sf-menu navbar-nav navbar-right'],
//         'items' => $useritems,
//     ]);
