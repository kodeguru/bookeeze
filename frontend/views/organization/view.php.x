...
<div class="organization-view">
    ...
    <p>
        <?= Html::a('Branches', ['create', ['id' => $model->id, 'parentid' =>$model->id]], ['class' => 'btn btn-success']) ?>
        <?= Html::a('services', ['organization-service-offer/create', 'id' => $model->id], ['class' => 'btn btn-info']) ?>
        <?= Html::a('Bookings', ['booking', 'id' => $model->id], ['class' => 'btn btn-warning']) ?>
